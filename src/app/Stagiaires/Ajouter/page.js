...
export default function AjouterStagiaire() {
  ...
  const [formData, setFormData] = useState({nom: "",prenom: "",email: "",phoneNumber: "",ecole: "",specialite: "",niveau: "",dateDebut: "",dateFin: "",encadrantId: "",status: "En attente",conventionValidee: false,documents: [],commentaires: [],});
    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className="flex-1 flex flex-col ml-64">
        ...
        <div className="flex-1 p-6">
          <div
            className={`max-w-4xl mx-auto bg-white rounded-lg shadow-sm border border-gray-200 transform transition-all duration-700 ease-out ${
              ...
              <div className="mb-8">
                ...
                <div className="mb-6">
                  ...
                  <select
                    ...
                    onChange={handleInputChange}
                    className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all ${
                      errors.encadrant ? "border-red-500" : "border-gray-300"
                    }`}
                  >
